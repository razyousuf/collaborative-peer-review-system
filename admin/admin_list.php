		...
		<div class="card-body">
			<table class="table tabe-hover table-bordered" id="list">
				...
				<tbody>
					<?php
					$i = 1;
					$qry = $conn->query("SELECT *,concat(firstname,' ',lastname) as name FROM users WHERE user_type = 1  order by concat(firstname,' ',lastname) asc");
...
<script>
	...
	$('.view_admin').click(function(){
		uni_modal("<i class='fa fa-id-card'></i> Admin Details","view_user.php?id="+$(this).attr('data-id'))
	})
